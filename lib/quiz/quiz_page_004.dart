...
import 'package:sanchu5c/quiz/answer_page_004.dart';
import 'package:sanchu5c/quiz/quiz_page_005.dart';

// ignore: must_be_immutable
class QuizPage004 extends StatelessWidget {
  QuizPage004({super.key});
    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Column(children: [
              ListTile(
                title: Image.asset('images/quiz/Q004/Q004.png'),
                //title: Image.network(
                        ...
                        onPressed: () {
                          if (kotae == 'o') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const AnswerPage004(
                                    //quizNoMoji: quizNoMoji,
                                    //bestQuizNoMoji: bestQuizNoMoji,
                                    ),
                              ),
