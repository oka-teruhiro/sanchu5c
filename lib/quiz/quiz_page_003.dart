...
import 'package:sanchu5c/quiz/answer_page_003.dart';
import 'package:sanchu5c/quiz/quiz_page_004.dart';

// ignore: must_be_immutable
class QuizPage003 extends StatelessWidget {
  QuizPage003({super.key});
    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Column(children: [
              ListTile(
                title: Image.asset('images/quiz/Q003/Q003.png'),
                //title: Image.network(
                        ...
                        onPressed: () {
                          if (kotae == 'o') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const AnswerPage003(
                                    //quizNoMoji: quizNoMoji,
                                    //bestQuizNoMoji: bestQuizNoMoji,
                                    ),
                              ),
